<?php 
 $select_config = [];
    ...
    $basename = \think\facade\Request::instance()->root();
    if (pathinfo($basename, PATHINFO_EXTENSION) == 'php') {
        $basename = dirname($basename);
    }
    $font_type=[
        ['code'=>1,'title'=>'黄草字体','path'=>$basename.'public/pc-ui/font/1.ttf'],
        ['code'=>2,'title'=>'硬笔行书','path'=>$basename.'public/pc-ui/font/2.ttf'],
        ['code'=>3,'title'=>'楷体','path'=>$basename.'public/pc-ui/font/3.ttf'], 
    ];
