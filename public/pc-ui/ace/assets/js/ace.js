...
*/
(function($ , undefined) {
	$("body").delegate('#ace-settings-btn',ace.click_event,function(e){
		e.preventDefault();
		$(this).toggleClass('open');
		$('#ace-settings-box').toggleClass('open');
	})
	$("body").delegate('#ace-settings-navbar','click',function(e){
		ace.settingFunction.navbar_fixed(null, this.checked);
	})
	$("body").delegate('#ace-settings-sidebar','click',function(e){
		ace.settingFunction.sidebar_fixed(null, this.checked);
	})
	$("body").delegate('#ace-settings-breadcrumbs','click',function(e){
		ace.settingFunction.breadcrumbs_fixed(null, this.checked);
	})
	$("body").delegate('#ace-settings-add-container','click',function(e){
		ace.settingFunction.main_container_fixed(null, this.checked);
	})	
	$("body").delegate('#ace-settings-compact','click',function(e){
		if(this.checked) {
	...
	$("body").delegate('#ace-settings-highlight','click',function(e){
	...
	$("body").delegate('#ace-settings-hover','click',function(e){
